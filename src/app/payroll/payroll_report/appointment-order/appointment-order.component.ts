...
@Component({
  selector: 'app-appointment-order',
  templateUrl: './appointment-order.component.html',
  styleUrls: ['./appointment-order.component.scss']
})
export class AppointmentOrderComponent implements OnInit {
@Input() employees:any;
@Input() info:any;
  options: FormGroup;
