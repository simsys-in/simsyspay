...
options: FormGroup;
listColumns: string[] =['i','id','bank','action'];
form:any={
bank: ''
};
lists:any;
...
simsUpdate(id){
let p = this.f.h;
this.http.put<any>(config.apiUrl+'payroll/bank/'+id,p,this.httpOptions).subscribe(res =>{
...
simsView(id){
this.formState='form';
this.http.get<any>(config.apiUrl+'payroll/bank/'+id,this.httpOptions).subscribe(res =>{
if (res.status =='token_expired') return this.routes.navigate(['logout']);
this.f.h = res;
console.log(res);
...
let p = this.f.h;
this.formState='form'
this.http.post<any>(config.apiUrl+'payroll/bank',p,this.httpOptions).subscribe(res =>{
if (res.status =='token_expired') return this.routes.navigate(['logout']);
...
simsDelete(id){
this.http.delete(config.apiUrl+'payroll/bank/'+id,this.httpOptions).subscribe(() => {
