...
import { MatTableDataSource, MatSort, MatPaginator, MatFormFieldDefaultOptions, MAT_FORM_FIELD_DEFAULT_OPTIONS } from '@angular/material';
...
ngOnInit() {
  ...
  if(this.f.id==null){
    ...
    this.routes.queryParams.subscribe((params)=>{ 
      ...
      this.detail_id=JSON.parse(params.data);
      this.employee(this.detail_id);
