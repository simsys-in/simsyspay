...
this.http.post<any>(config.apiUrl+'/api/billing/purchase_invoice',request,this.httpOptions).subscribe(res => {
...
simsUpdate(id){
this.http.put<any>(config.apiUrl+'/api/billing/purchase_invoice/'+id,this.headForm.value,this.httpOptions).subscribe(res => {
...
simsDelete(id){
  this.http.delete(config.apiUrl+'/api/billing/purchase_invoice/'+id,this.httpOptions).subscribe(res => {
...
this.http.get<any>(config.apiUrl+'/api/billing/purchase_invoice',httpOptions).subscribe(res => {
this.rows = res;
});
}
...
this.http.get<any>(config.apiUrl+'/api/billing/purchase_invoice/'+id,httpOptions).subscribe(
res => {
this.f.purchase_invoice.setValue(res.purchase_invoice);
