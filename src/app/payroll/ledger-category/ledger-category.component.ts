...
styleUrls:['./ledger-category.component.scss']
})
...
this.http.post<any>(config.apiUrl+'/api/billing/ledger_category',request,this.httpOptions).subscribe(res => {
...
simsUpdate(id){
this.http.put<any>(config.apiUrl+'/api/billing/ledger_category/'+id,this.headForm.value,this.httpOptions).subscribe(res => {
...
simsDelete(id){
  this.http.delete(config.apiUrl+'/api/billing/ledger_category/'+id,this.httpOptions).subscribe(res => {
...
this.http.get<any>(config.apiUrl+'/api/billing/ledger_category',httpOptions).subscribe(res => {
  this.rows = res;
});
}
...
this.http.get<any>(config.apiUrl+'/api/billing/ledger_category/'+id,httpOptions).subscribe(
res => {
this.f.ledger_category.setValue(res.ledger_category);
