...
@Component({
selector: 'app-jobwork-outward',
templateUrl: './jobwork-outward.component.html',
styleUrls:['./jobwork-outward.component.scss'],
})

export class JobworkOutwardComponent implements OnInit {
rows:any;
headForm: FormGroup;
isForm = true;
ledgers:any;
...
from_process_id:new FormControl(''),
to_process_id:new FormControl(''),
...
console.log(request);
this.http.post<any>(config.apiUrl+'garments/jobwork_outward',request,this.httpOptions).subscribe(res => {
...
simsUpdate(id){
this.http.put<any>(config.apiUrl+'garments/jobwork_outward'+id,this.headForm.value,this.httpOptions).subscribe(() => {
...
simsDelete(id){
  this.http.delete(config.apiUrl+'garments/jobwork_outward'+id,this.httpOptions).subscribe(() => {
...
this.http.get<any>(config.apiUrl+'garments/jobwork_outward',this.httpOptions).subscribe(res => {
this.rows = res;
});
}
...
simsView(id){
this.http.get<any>(config.apiUrl+'garments/jobwork_outward'+id,this.httpOptions).subscribe(
res => {
