...
console.log(request);
this.http.post<any>(config.apiUrl+'billing/ledger_category',request,this.httpOptions).subscribe(res => {
...
simsUpdate(id){
this.http.put<any>(config.apiUrl+'billing/ledger_category/'+id,this.headForm.value,this.httpOptions).subscribe(() => {
...
simsDelete(id){
  this.http.delete(config.apiUrl+'billing/ledger_category/'+id,this.httpOptions).subscribe(() => {
...
this.http.get<any>(config.apiUrl+'billing/ledger_category',this.httpOptions).subscribe(res => {
this.rows = res;
});
}
...
simsView(id){
this.http.get<any>(config.apiUrl+'billing/ledger_category/'+id,this.httpOptions).subscribe(
res => {
