...
@Component({
selector: 'app-fabric-outward',
templateUrl: './fabric-outward.component.html',
styleUrls:['./fabric-outward.component.scss'],
})

export class FabricOutwardComponent implements OnInit {
rows:any;
headForm: FormGroup;
isForm = true;
ledgers:any;
...
console.log(request);
this.http.post<any>(config.apiUrl+'garments/fabric_outward',request,this.httpOptions).subscribe(res => {
...
simsUpdate(id){
this.http.put<any>(config.apiUrl+'garments/fabric_outward'+id,this.headForm.value,this.httpOptions).subscribe(() => {
...
simsDelete(id){
  this.http.delete(config.apiUrl+'garments/fabric_outward'+id,this.httpOptions).subscribe(() => {
...
this.http.get<any>(config.apiUrl+'garments/fabric_outward',this.httpOptions).subscribe(res => {
this.rows = res;
});
}
...
simsView(id){
this.http.get<any>(config.apiUrl+'garments/fabric_outward'+id,this.httpOptions).subscribe(
res => {
