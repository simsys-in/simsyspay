...
@Component({
selector: 'app-fabric-invoice',
templateUrl: './fabric-invoice.component.html',
styleUrls:['./fabric-invoice.component.scss'],
})

export class FabricInvoiceComponent implements OnInit {
rows:any;
headForm: FormGroup;
isForm = true;
ledgers:any;
...
console.log(request);
this.http.post<any>(config.apiUrl+'garments/fabric_invoice',request,this.httpOptions).subscribe(res => {
...
simsUpdate(id){
this.http.put<any>(config.apiUrl+'garments/fabric_invoice'+id,this.headForm.value,this.httpOptions).subscribe(() => {
...
simsDelete(id){
  this.http.delete(config.apiUrl+'garments/fabric_invoice'+id,this.httpOptions).subscribe(() => {
...
this.http.get<any>(config.apiUrl+'garments/fabric_invoice',this.httpOptions).subscribe(res => {
this.rows = res;
});
}
...
simsView(id){
this.http.get<any>(config.apiUrl+'garments/fabric_invoice'+id,this.httpOptions).subscribe(
res => {
