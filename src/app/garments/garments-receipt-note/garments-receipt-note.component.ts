...
@Component({
selector: 'app-garments-receipt-note',
templateUrl: './garments-receipt-note.component.html',
styleUrls:['./garments-receipt-note.component.scss'],
})

export class GarmentsReceiptNoteComponent implements OnInit {
rows:any;
headForm: FormGroup;
isForm = true;
ledgers:any;
...
console.log(request);
this.http.post<any>(config.apiUrl+'garments/garments_receipt_note',request,this.httpOptions).subscribe(res => {
...
simsUpdate(id){
this.http.put<any>(config.apiUrl+'garments/garments_receipt_note'+id,this.headForm.value,this.httpOptions).subscribe(() => {
...
simsDelete(id){
  this.http.delete(config.apiUrl+'garments/garments_receipt_note'+id,this.httpOptions).subscribe(() => {
...
this.http.get<any>(config.apiUrl+'garments/garments_receipt_note',this.httpOptions).subscribe(res => {
this.rows = res;
});
}
...
simsView(id){
this.http.get<any>(config.apiUrl+'garments/garments_receipt_note'+id,this.httpOptions).subscribe(
res => {
