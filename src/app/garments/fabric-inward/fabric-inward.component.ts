...
@Component({
selector: 'app-fabric-inward',
templateUrl: './fabric-inward.component.html',
styleUrls:['./fabric-inward.component.scss'],
})

export class FabricInwardComponent implements OnInit {
rows:any;
headForm: FormGroup;
isForm = true;
ledgers:any;
...
console.log(request);
this.http.post<any>(config.apiUrl+'garments/fabric_inward',request,this.httpOptions).subscribe(res => {
...
simsUpdate(id){
this.http.put<any>(config.apiUrl+'garments/fabric_inward'+id,this.headForm.value,this.httpOptions).subscribe(() => {
...
simsDelete(id){
  this.http.delete(config.apiUrl+'garments/fabric_inward'+id,this.httpOptions).subscribe(() => {
...
this.http.get<any>(config.apiUrl+'garments/fabric_inward',this.httpOptions).subscribe(res => {
this.rows = res;
});
}
...
simsView(id){
this.http.get<any>(config.apiUrl+'garments/fabric_inward'+id,this.httpOptions).subscribe(
res => {
