...
console.log(request);
this.http.post<any>(config.apiUrl+'billing/product_group',request,this.httpOptions).subscribe(res => {
...
simsUpdate(id){
this.http.put<any>(config.apiUrl+'billing/product_group/'+id,this.headForm.value,this.httpOptions).subscribe(() => {
...
simsDelete(id){
  this.http.delete(config.apiUrl+'billing/product_group/'+id,this.httpOptions).subscribe(() => {
...
this.http.get<any>(config.apiUrl+'billing/product_group',this.httpOptions).subscribe(res => {
this.rows = res;
});
}
...
simsView(id){
this.http.get<any>(config.apiUrl+'billing/product_group/'+id,this.httpOptions).subscribe(
res => {
