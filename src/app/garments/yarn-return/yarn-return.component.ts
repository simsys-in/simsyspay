...
@Component({
selector: 'app-yarn-return',
templateUrl: './yarn-return.component.html',
styleUrls:['./yarn-return.component.scss'],
})

export class YarnReturnComponent implements OnInit {
rows:any;
headForm: FormGroup;
isForm = true;
ledgers:any;
...
console.log(request);
this.http.post<any>(config.apiUrl+'garments/yarn_return',request,this.httpOptions).subscribe(res => {
...
simsUpdate(id){
this.http.put<any>(config.apiUrl+'garments/yarn_return'+id,this.headForm.value,this.httpOptions).subscribe(() => {
...
simsDelete(id){
  this.http.delete(config.apiUrl+'garments/yarn_return'+id,this.httpOptions).subscribe(() => {
...
this.http.get<any>(config.apiUrl+'garments/yarn_return',this.httpOptions).subscribe(res => {
this.rows = res;
});
}
...
simsView(id){
this.http.get<any>(config.apiUrl+'garments/yarn_return'+id,this.httpOptions).subscribe(
res => {
